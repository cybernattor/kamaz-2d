...
export interface VehicleInstance {
   ...
   */
  dazedTimer?: number;
  /** NPC lifecycle: a car may be parked while its driver is on foot. */
  npcParked?: boolean;
}
...
export interface Pedestrian {
  ...
  /** Temporary pedestrian generated by an NPC parking stop. */
  parkingRole?: 'exiting' | 'waiting' | 'entering';
  parkingTimer?: number;
}
