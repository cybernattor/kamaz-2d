  ...
  public initMissions() {
    this.missions = [
      ...
      },
      {
        ...
        sourcePoiId: 'poi_truck_stop',
        targetPoiId: 'poi_police',
        rewardMoney: 12000,
        rewardXp: 300,
